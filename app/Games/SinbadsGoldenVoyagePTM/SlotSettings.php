    ...
    class SlotSettings
    {
        ...
        public function GetReelStrips0($rIndex)
        {
            ...
            for( $i = 0; $i <= 5; $i++ )
            {
                ...
                $reel['reel' . ($i + 1)] = [
                    ...
                    (string)$currentReels[$i][$tmpRp + 4],
                    (string)$currentReels[$i][$tmpRp + 5],
                    (string)$currentReels[$i][$tmpRp + 6]
                ];
            }
            return $reel;
        }
        public function GetSpinWin(&$reels, $lines, $betLine, $linesId, $wild, $scatter, $bonusMpl, $stype)
        {
            ...
            for( $r = 1; $r <= 6; $r++ )
            {
                for( $p = 0; $p <= 6; $p++ )
                {
                    $reels['reel' . $r][$p] = (int)$reels['reel' . $r][$p];
                    if( $reels['reel' . $r][$p] == 117 )
                    {
                        $reels['reel' . $r][$p] = 333;
                    }
                    else if( $reels['reel' . $r][$p] == 118 )
                    {
                        $reels['reel' . $r][$p] = 333;
                        $reels['reel' . ($r + 1)][$p] = 333;
                        $reels['reel' . ($r - 1)][$p] = 333;
                    }
                    else if( $reels['reel' . $r][$p] == 119 )
                    {
                        $reels['reel' . $r][$p] = 333;
                        $reels['reel' . ($r + 1)][$p] = 333;
                        $reels['reel' . ($r - 1)][$p] = 333;
                    }
                    else if( $reels['reel' . $r][$p] == 120 )
                    {
                        $reels['reel' . $r][$p] = 333;
                        $reels['reel' . ($r + 1)][$p] = 333;
                        $reels['reel' . ($r - 1)][$p] = 333;
                    }
                    else if( $reels['reel' . $r][$p] == 121 )
                    {
                        $reels['reel' . $r][$p] = 333;
                        $reels['reel' . ($r + 1)][$p] = 333;
                        $reels['reel' . ($r - 1)][$p] = 333;
                    ...
                    else
                    {
                        ...
                        if( $reels['reel' . $r][$p] == 27 || $reels['reel' . $r][$p] == 28 )
                        {
                            $reels['reel' . $r][$p] = 12;
                        }
                        else if( $reels['reel' . $r][$p] >= 29 && $reels['reel' . $r][$p] <= 55 )
                        {
                            $reels['reel' . $r][$p] = 9;
                        }
                        else if( $reels['reel' . $r][$p] >= 56 && $reels['reel' . $r][$p] <= 82 )
                        {
                            $reels['reel' . $r][$p] = 8;
                        }
                        else if( $reels['reel' . $r][$p] >= 83 && $reels['reel' . $r][$p] <= 109 )
                        {
                            $reels['reel' . $r][$p] = 7;
                        }
                        else if( $reels['reel' . $r][$p] == 110 )
                        {
                            $reels['reel' . $r][$p] = 6;
                        }
                        else if( $reels['reel' . $r][$p] == 111 )
                        {
                            $reels['reel' . $r][$p] = 4;
                        }
                        else if( $reels['reel' . $r][$p] == 112 )
                        {
                            $reels['reel' . $r][$p] = 5;
                        }
                        else if( $reels['reel' . $r][$p] == 113 )
                        {
                            $reels['reel' . $r][$p] = 3;
                        }
                        else if( $reels['reel' . $r][$p] == 114 )
                        {
                            $reels['reel' . $r][$p] = 2;
                        }
                        else if( $reels['reel' . $r][$p] == 115 )
                        {
                            $reels['reel' . $r][$p] = 1;
                        }
                        else if( $reels['reel' . $r][$p] == 116 )
                        {
                            $reels['reel' . $r][$p] = 0;
                        }
                    }
                ...
                for( $j = 0; $j < count($this->SymbolGame); $j++ )
                {
                    ...
                    else
                    {
                        ...
                        if( $s[0] == $csym || in_array($s[0], $wild) )
                        {
                            ...
                            {
                                $cWins[$k] = $tmpWin;
                                $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $this->GetGameData('SinbadsGoldenVoyagePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                            }
                        }
                        if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) )
                        {
                            ...
                            {
                                $cWins[$k] = $tmpWin;
                                $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $this->GetGameData('SinbadsGoldenVoyagePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                            }
                        }
                        if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) )
                        {
                            ...
                            {
                                $cWins[$k] = $tmpWin;
                                $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $this->GetGameData('SinbadsGoldenVoyagePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                            }
                        }
                        if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) )
                        {
                            ...
                            {
                                $cWins[$k] = $tmpWin;
                                $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $this->GetGameData('SinbadsGoldenVoyagePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                            }
                        }
                        if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) )
                        {
                            ...
                            {
                                $cWins[$k] = $tmpWin;
                                $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $this->GetGameData('SinbadsGoldenVoyagePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                            }
                        }
                        if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) && ($s[5] == $csym || in_array($s[5], $wild)) )
                        {
                            ...
                            $tmpWin = $this->Paytable['SYM_' . $csym][6] * $betLine * $mpl * $bonusMpl;
                            if( $cWins[$k] < $tmpWin )
                            {
                                $cWins[$k] = $tmpWin;
                                $tmpStringWin = '{"Count":6,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $this->GetGameData('SinbadsGoldenVoyagePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                            }
                        }
                    }
                }
