<?php
namespace VanguardLTE\Games\PrinceOfOlympusJPPTM
{
    class SlotSettings
    {
        ...
        public function GetRandomScatterPos($rp, $rSym)
        {
            if( $rSym == 0 )
            {
                ...
                {
                    if( $rp[$i] == $rSym && isset($rp[$i + 1]) && isset($rp[$i - 1]) )
                    {
            ...
            else
            {
                ...
                if( $rSym == 12 )
                {
                    ...
                    for( $i = 0; $i < count($reelsId); $i++ )
                    {
                        if( $reelsId_[$i] )
                        {
                            $prs[$reelsId[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $reelsId[$i]}, $rSym);
                        }
                        else
                        {
