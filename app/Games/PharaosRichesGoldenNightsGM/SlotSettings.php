<?php
namespace VanguardLTE\Games\PharaosRichesGoldenNightsGM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->FirepotPaytable = [];
            $this->FirepotPaytable[0] = [
                0,
                0,
                0,
                0,
        ...
        public function SaveLogReport($spinSymbols, $bet, $lines, $win, $slotState)
        {
            ...
            $this->game->refresh();
            if( $slotState != 'slotGamble' && $slotState != 'slotGamble2' )
            {
        ...
        public function GetSpinSettings($garantType = 'bet', $bet, $lines)
        {
            ...
            else if( $this->GetGameDataStatic('RtpControlCount') < 0 )
            {
                ...
                if( $this->GetGameDataStatic('RtpControlCount') < (-1 * ($RtpControlCount * 5)) && $currentPercent - 1 <= $rtpRange && $rtpRange <= ($currentPercent + 2) )
                {
                    $this->SetGameDataStatic('RtpControlCount', $RtpControlCount);
                }
            }
