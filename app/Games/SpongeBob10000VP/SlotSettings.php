<?php
namespace VanguardLTE\Games\SpongeBob10000VP
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->Paytable['Fish_17'] = [40];
            $this->Paytable['Fish_18'] = [50];
            $this->Paytable['Fish_19'] = [100];
            $this->Paytable['Fish_20'] = [4];
            $this->Paytable['Fish_21'] = [4];
            $this->Paytable['Fish_22'] = [4];
            $this->Paytable['Fish_23'] = [0];
            $this->Paytable['Fish_24'] = [0];
            $this->Paytable['Fish_25'] = [4];
            ...
            $this->FishDamage['Fish_20'] = [5];
            $this->FishDamage['Fish_21'] = [5];
            $this->FishDamage['Fish_22'] = [5];
            $this->FishDamage['Fish_23'] = [5];
            $this->FishDamage['Fish_24'] = [100];
            $this->FishDamage['Fish_25'] = [5];
