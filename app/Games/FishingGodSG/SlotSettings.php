...
namespace VanguardLTE\Games\FishingGodSG
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->scaleMode = 0;
            $this->numFloat = 0;
            $this->Paytable['Fish_0'] = [2];
            $this->Paytable['Fish_1'] = [3];
            $this->Paytable['Fish_2'] = [4];
            $this->Paytable['Fish_3'] = [5];
            $this->Paytable['Fish_4'] = [6];
            $this->Paytable['Fish_5'] = [7];
            $this->Paytable['Fish_6'] = [8];
            $this->Paytable['Fish_7'] = [9];
            $this->Paytable['Fish_8'] = [10];
            $this->Paytable['Fish_9'] = [12];
            $this->Paytable['Fish_10'] = [15];
            $this->Paytable['Fish_11'] = [18];
            $this->Paytable['Fish_12'] = [20];
            $this->Paytable['Fish_13'] = [25];
            $this->Paytable['Fish_14'] = [30];
            $this->Paytable['Fish_15'] = [40];
            $this->Paytable['Fish_16'] = [50];
            ...
            $this->Paytable['Fish_19'] = [
                40,
                80
            ];
            $this->Paytable['Fish_20'] = [
                40,
                90
            ];
            $this->Paytable['Fish_21'] = [
                50,
                100
            ];
            $this->Paytable['Fish_22'] = [
                50,
                100
            ];
            $this->Paytable['Fish_23'] = [
                60,
                200
            ];
            $this->Paytable['Fish_24'] = [
                60,
                888
            ];
            $this->Paytable['Fish_101'] = [0];
            $this->Paytable['Fish_102'] = [0];
            $this->Paytable['Fish_103'] = [0];
            $this->Paytable['Fish_104'] = [0];
            $this->Paytable['Fish_105'] = [0];
            $this->Paytable['Fish_106'] = [0];
            $this->Paytable['Fish_107'] = [0];
            $this->Paytable['Fish_108'] = [0];
            $this->Paytable['Fish_109'] = [0];
            $this->Paytable['Fish_30'] = [0];
            $this->FishDamage = [];
            $this->FishDamage['Fish_0'] = [3];
            $this->FishDamage['Fish_101'] = [5];
            $this->FishDamage['Fish_1'] = [3];
            $this->FishDamage['Fish_2'] = [3];
            $this->FishDamage['Fish_3'] = [3];
            $this->FishDamage['Fish_4'] = [4];
            $this->FishDamage['Fish_5'] = [4];
            $this->FishDamage['Fish_6'] = [4];
            $this->FishDamage['Fish_7'] = [4];
            $this->FishDamage['Fish_8'] = [4];
            $this->FishDamage['Fish_9'] = [5];
            $this->FishDamage['Fish_10'] = [5];
            $this->FishDamage['Fish_11'] = [5];
            $this->FishDamage['Fish_12'] = [10];
            $this->FishDamage['Fish_13'] = [25];
            $this->FishDamage['Fish_14'] = [25];
            $this->FishDamage['Fish_15'] = [30];
            $this->FishDamage['Fish_16'] = [30];
            $this->FishDamage['Fish_17'] = [30];
            $this->FishDamage['Fish_18'] = [50];
            $this->FishDamage['Fish_19'] = [70];
            $this->FishDamage['Fish_20'] = [70];
            $this->FishDamage['Fish_21'] = [70];
            $this->FishDamage['Fish_22'] = [70];
            $this->FishDamage['Fish_23'] = [70];
            $this->FishDamage['Fish_24'] = [70];
            $this->FishDamage['Fish_101'] = [100];
            $this->FishDamage['Fish_102'] = [100];
            $this->FishDamage['Fish_103'] = [100];
            $this->FishDamage['Fish_104'] = [200];
            $this->FishDamage['Fish_105'] = [100];
            $this->FishDamage['Fish_106'] = [100];
            $this->FishDamage['Fish_107'] = [200];
            $this->FishDamage['Fish_108'] = [200];
            $this->FishDamage['Fish_109'] = [200];
