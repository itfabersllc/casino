<?php
namespace VanguardLTE\Games\DragonsKingdomAM
{
    class SlotSettings
    {
        ...
        public function FormatReelStrips($pf, $wsym)
        {
            $resultReelStrips = '';
            foreach( [
                'reelStrip' . $pf . '1',
        ...
        public function GetReelStrips($winType, $slotEvent, $wsym)
        {
            $game = $this->game;
            if( $slotEvent == 'freespin' )
            {
                ...
                ] as $reelStrip )
                {
                    ...
                    if( count($curReel) )
                    {
                        ...
                        foreach( $this->$reelStrip as &$rsym )
                        {
                            if( $rsym == 11 )
                            {
                                $rsym = $wsym;
