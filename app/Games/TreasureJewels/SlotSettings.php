<?php
namespace VanguardLTE\Games\TreasureJewels
{
    class SlotSettings
    {
        ...
        public $slotWinLineMode = null;
        public $slotBonusLimitStart = null;
        public $slotBonusMaxLimitStart = null;
        public $slotBonusRetriger = null;
        public $slotMultiScatter = null;
        public $slotBonusReelsFixed = [];
        public $slotGamble = null;
        public $Paytable = [];
        public $slotSounds = [];
        public $increaseFreeSpinsMpl = null;
        public $increaseFreeSpinsCount = null;
        public $doubleFreeWin = null;
        public $doubleFreeWinSym = null;
        private $presetGame = null;
        private $jpgs = null;
        private $Bank = null;
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->slotWildMpl = 1;
            $this->GambleType = 1;
            $this->slotMultiScatter = false;
            $this->doubleFreeWin = false;
            $this->doubleFreeWinSym = '';
            $this->slotWinLineMode = 'LeftRightMiddle';
            $this->slotBonusLimitStart = 3;
            $this->slotBonusMaxLimitStart = 3;
            $this->increaseFreeSpinsCount = 0;
            $this->increaseFreeSpinsMpl = 0;
            $this->slotBonusRetriger = false;
            $this->slotBonusReelsFixed = ['countFixedReels' => 0];
            $this->slotFreeCount = 0;
            $this->slotFreeMpl = 0;
