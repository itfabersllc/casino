<?php
namespace VanguardLTE\Games\GemQueen
{
    class SlotSettings
    {
        ...
        public function CheckDuplicateSym($symArr)
        {
            $isAccept = true;
            if( $symArr[0] == $symArr[1] || $symArr[0] == $symArr[2] )
            {
                $isAccept = false;
            }
            if( $symArr[1] == $symArr[0] || $symArr[1] == $symArr[2] )
            {
                $isAccept = false;
            }
            if( $symArr[2] == $symArr[1] || $symArr[2] == $symArr[0] )
            {
                $isAccept = false;
            }
            return $isAccept;
        ...
        public function GetReelStripsByPosition($rp, $mode)
        {
            $game = $this->game;
            if( $mode == 'freespin' )
            {
