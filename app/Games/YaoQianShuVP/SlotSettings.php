...
namespace VanguardLTE\Games\YaoQianShuVP
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->Paytable['Fish_18'] = [100];
            $this->Paytable['Fish_19'] = [120];
            $this->Paytable['Fish_20'] = [
                120,
                600
            ];
            $this->Paytable['Fish_21'] = [174];
            $this->Paytable['Fish_22'] = [100];
            $this->Paytable['Fish_23'] = [60];
            ...
            $this->Paytable['Fish_31'] = [0];
            $this->Paytable['Fish_32'] = [0];
            $this->FishDamage = [];
            ...
            $this->FishDamage['Fish_31'] = [200];
            $this->FishDamage['Fish_32'] = [200];
            $reel = new GameReel();
            foreach( [
                'reelStrip1',
                'reelStrip2',
