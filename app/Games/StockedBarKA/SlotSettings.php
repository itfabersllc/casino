<?php
namespace VanguardLTE\Games\StockedBarKA
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->currencyChar = [];
            $this->currencyChar['USD'] = '$';
            $this->currencyChar['EUR'] = '€';
        ...
        public function GetRandomScatterPos($rp, $sym)
        {
            $rpResult = [];
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            else
            {
                ...
                if( $bonusType == 1 )
                {
                    ...
                    $scattersCnt = rand(4, 5);
                    for( $i = 0; $i < count($reelsId); $i++ )
                    {
                        if( $i < $scattersCnt )
                        {
                            $prs[$reelsId[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $reelsId[$i]}, '6');
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    for( $i = 0; $i < count($reelsId); $i++ )
                    {
                        if( $i < $scattersCnt )
                        {
                            $prs[$reelsId[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $reelsId[$i]}, '11');
                        }
                        else
                        {
                            $prs[$reelsId[$i]] = rand(0, count($this->{'reelStrip' . $reelsId[$i]}) - 3);
