<?php
namespace VanguardLTE\Games\BeetleMania
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->doubleFreeWin = true;
            $this->doubleFreeWinSym = 'X_2';
            $this->slotWinLineMode = 'Left';
            $this->slotBonusLimitStart = 3;
            $this->slotBonusMaxLimitStart = 5;
            $this->increaseFreeSpinsCount = 1;
            $this->increaseFreeSpinsMpl = 0;
            $this->slotBonusRetriger = true;
