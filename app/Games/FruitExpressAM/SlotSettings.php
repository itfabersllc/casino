<?php
namespace VanguardLTE\Games\FruitExpressAM
{
    class SlotSettings
    {
        ...
        public function FormatReelStrips($pf, $ks)
        {
            $resultReelStrips = '';
            foreach( [
                'reelStrip' . $pf . '1',
        ...
        public function GetReelStrips($winType, $slotEvent, $ks)
        {
            $game = $this->game;
            if( $slotEvent == 'freespin' )
            {
                ...
                ] as $index => $reelStrip )
                {
                    if( $index == 0 || $index == 4 )
                    {
                        $curReel = $fArr0['reelStrip' . ($index + 1)];
                    }
                    else
                    {
                        $curReel = $fArr['reelStripBonus' . ($index + 1)];
                    }
                    if( count($curReel) )
                    {
