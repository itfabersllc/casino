...
namespace VanguardLTE\Games\MultiWinTripleAM
{
    class SlotSettings
    {
        ...
        public function GetCombination($cards, $suits, $tipMode)
        {
            ...
            for( $i = 2; $i <= 14; $i++ )
            {
                if( $cardsAmount[$i] == (2 + $cardsAmount[$wild]) && $combinations[1]['amount'] == 1 )
                {
                    $combinations[3]['amount'] = 1;
                    $combinations[3]['cards'][0] = $i;
                    $combinations[3]['cards'][1] = $combinations[1]['cards'][0];
                    $combinations[3]['cards'][2] = $wild;
                    if( $cardsAmount[$wild] > 0 )
                    {
                        $combinations[3]['wild'] = 1;
                    }
                }
                if( $cardsAmount[$i] + $cardsAmount[$wild] == 2 )
                {
                    $combinations[1]['amount'] = 1;
                    $combinations[1]['cards'][0] = $i;
                    $combinations[1]['cards'][2] = $wild;
                    if( $cardsAmount[$wild] > 0 )
                    {
                        $combinations[1]['wild'] = 1;
                    }
                }
                if( $cardsAmount[$i] + $cardsAmount[$wild] == 3 )
                {
                    $combinations[4]['amount'] = 1;
                    $combinations[4]['cards'][0] = $i;
                    $combinations[4]['cards'][2] = $wild;
                    $combinations[4]['weight'] += 1;
                    if( $cardsAmount[$wild] > 0 )
                    {
                        $combinations[4]['wild'] = 1;
                    }
                }
                if( $cardsAmount[$i] + $cardsAmount[$wild] == 4 )
                {
                    $combinations[9]['amount'] = 1;
                    $combinations[9]['cards'][0] = $i;
                    $combinations[9]['cards'][2] = $wild;
                }
                else if( $cardsAmount[$i] + $cardsAmount[$wild] == 5 )
                {
                    $combinations[9]['amount'] = 1;
                    $combinations[9]['cards'][0] = $i;
                    $combinations[9]['cards'][2] = $wild;
                ...
                else
                {
                    ...
                    for( $s_c = 0; $s_c < 5; $s_c++ )
                    {
                        ...
                        else if( $cardsAmount[$i + $s_c] == 1 )
                        {
                            $straightCount += 1;
                        }
                    }
                    if( $cardsAmount[$wild] + $straightCount == 5 )
                    {
                        $combinations[5]['amount'] = 1;
                        $combinations[5]['cards'] = $cards;
                    }
                    else
                    {
                        $straightCount = 0;
                        for( $s_c = 0; $s_c <= 8; $s_c += 2 )
                        {
                            if( $i + $s_c == 15 )
                            {
                            }
                        ...
                        if( $cardsAmount[$wild] + $straightCount == 5 )
                        {
                            ...
                            $combinations[8]['cards'] = $cards;
                        }
                    }
                }
            }
            $picCount = $cardsAmount[11] + $cardsAmount[12] + $cardsAmount[13] + $cardsAmount[$wild];
            if( $picCount == 5 )
            {
                $combinations[10]['amount'] = 1;
                $combinations[10]['cards'] = $cards;
            }
            $cornerStraightCount = 0;
            if( $cardsAmount[2] == 1 )
            {
                $cornerStraightCount += 1;
            }
            if( $cardsAmount[3] == 1 )
            {
                $cornerStraightCount += 1;
            ...
            $cornerStraightCount += $cardsAmount[$wild];
            if( $cornerStraightCount == 5 )
            {
                $combinations[11]['amount'] = 1;
                $combinations[11]['cards'] = $cards;
            }
            if( $combinations[1]['amount'] == 1 && $combinations[4]['amount'] == 1 && $combinations[1]['wild'] != 1 )
            {
                $combinations[7]['amount'] = 1;
                $combinations[7]['cards'] = $cards;
            }
            if( $combinations[4]['weight'] == 2 && $combinations[4]['amount'] == 1 )
            {
                $combinations[7]['amount'] = 1;
                $combinations[7]['cards'] = $cards;
            }
            ...
            if( $fcArr[0] + $cardsAmount[$wild] >= 4 )
            {
                $csuit = 0;
            }
            if( $fcArr[1] + $cardsAmount[$wild] >= 4 )
            {
                $csuit = 1;
            }
            if( $fcArr[2] + $cardsAmount[$wild] >= 4 )
            {
                $csuit = 2;
            }
            if( $fcArr[3] + $cardsAmount[$wild] >= 4 )
            {
                $csuit = 3;
            }
            if( $csuit >= 0 )
            {
                ...
                for( $ss = 0; $ss < 5; $ss++ )
                {
                    if( $csuit == $suits[$ss] || $cards[$ss] == $wild )
                    {
                        $combinations[2]['cards'][$ss_] = $cards[$ss];
                        $ss_++;
                    }
                }
            }
            ...
            for( $cl = 0; $cl <= 3; $cl++ )
            {
                if( $cSuits[$cl] + $cardsAmount[$wild] >= 5 )
                {
                    $combinations[6]['amount'] = 1;
                    $combinations[6]['cards'] = $cards;
                }
            }
            if( $combinations[6]['amount'] == 1 && $combinations[5]['amount'] == 1 )
            {
            ...
            for( $i = 0; $i < 5; $i++ )
            {
                if( $combinations[2]['amount'] == 1 && $rang == 2 )
                {
                    if( $csuit == $suits[$i] || $cards[$i] == $wild )
                    {
                        $holds[$i] = $cards[$i];
                    }
                }
            ...
            if( $tipMode )
            {
                ...
                for( $i = 2; $i <= 14; $i++ )
                {
                    ...
                    for( $s_c = 0; $s_c < 5; $s_c++ )
                    {
                        ...
                        {
                            $crdsS[$straightCount] = $i + $s_c;
                            $straightCount += 1;
                        }
                    }
                    if( $cardsAmount[$wild] + $straightCount == 4 )
                    {
                        $combinations[5]['amount'] = 1;
                        $combinations[5]['cards'][0] = $crdsS[0];
                        $combinations[5]['cards'][1] = $crdsS[1];
                        $combinations[5]['cards'][2] = $crdsS[2];
                        $combinations[5]['cards'][3] = $crdsS[3];
                        if( $cardsAmount[$wild] >= 1 )
                        {
                            $combinations[5]['cards'][4] = $wild;
                        }
                    }
                    else
                    {
                        ...
                        {
                            $combinations[8]['amount'] = 1;
                            $combinations[8]['cards'][0] = $crdsS[0];
                            $combinations[8]['cards'][1] = $crdsS[1];
                            $combinations[8]['cards'][2] = $crdsS[2];
                            $combinations[8]['cards'][3] = $crdsS[3];
                            if( $cardsAmount[$wild] >= 1 )
                            {
                                $combinations[8]['cards'][4] = $wild;
                            }
                        }
                    }
                }
                ...
                {
                    $combinations[10]['amount'] = 1;
                    $combinations[10]['cards'][0] = 11;
                    $combinations[10]['cards'][1] = 12;
                    $combinations[10]['cards'][2] = 13;
                }
                $fcArr = [
                    0,
                    0,
                ...
                if( $fcArr[0] + $cardsAmount[$wild] >= 3 )
                {
                    $csuit = 0;
                }
                if( $fcArr[1] + $cardsAmount[$wild] >= 3 )
                {
                    $csuit = 1;
                }
                if( $fcArr[2] + $cardsAmount[$wild] >= 3 )
                {
                    $csuit = 2;
                }
                if( $fcArr[3] + $cardsAmount[$wild] >= 3 )
                {
                    $csuit = 3;
                }
                if( $csuit >= 0 )
                ...
                if( $csuit >= 0 )
                {
                    ...
                    for( $ss = 0; $ss < 5; $ss++ )
                    {
                        if( $csuit == $suits[$ss] || $cards[$ss] == $wild )
                        {
                            $combinations[6]['cards'][$ss_] = $cards[$ss];
                            $ss_++;
                        }
                    }
                }
                for( $i = count($combinations) - 1; $i >= 1; $i-- )
                {
                    if( $combinations[$i]['amount'] == 1 && $rang < $i )
                    {
                        $holds = [
                            0,
                            0,
                ...
                for( $i = 0; $i < 5; $i++ )
                {
                    if( $rangTip == 5 || $rangTip == 8 )
                    {
                        if( $trCards[$cards[$i]] == 0 && in_array($cards[$i], $hcards) || $cards[$i] == $wild )
                        {
                            $trCards[$cards[$i]]++;
                            $holds[$i] = $cards[$i];
                        }
                    }
                    else if( $rangTip == 6 || $rangTip == 2 )
                    {
                        if( $trCards[$cards[$i]] == 0 && in_array($cards[$i], $hcards) || $cards[$i] == $wild )
                        {
                            $trCards[$cards[$i]]++;
