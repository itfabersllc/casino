<?php
namespace VanguardLTE\Games\JinChanBuYu10000VP
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->Paytable['Fish_8'] = [8];
            $this->Paytable['Fish_9'] = [9];
            $this->Paytable['Fish_10'] = [10];
            $this->Paytable['Fish_11'] = [12];
            $this->Paytable['Fish_12'] = [15];
            $this->Paytable['Fish_13'] = [18];
            $this->Paytable['Fish_14'] = [20];
            $this->Paytable['Fish_15'] = [25];
            $this->Paytable['Fish_16'] = [30];
            $this->Paytable['Fish_17'] = [35];
            ...
            $this->Paytable['Fish_20'] = [300];
            $this->Paytable['Fish_21'] = [15];
            $this->Paytable['Fish_22'] = [18];
            $this->Paytable['Fish_23'] = [30];
            $this->Paytable['Fish_24'] = [36];
            $this->Paytable['Fish_25'] = [45];
            $this->Paytable['Fish_26'] = [54];
            ...
            $this->FishDamage['Fish_9'] = [8];
            $this->FishDamage['Fish_10'] = [9];
            $this->FishDamage['Fish_11'] = [10];
            ...
            $this->FishDamage['Fish_18'] = [70];
            $this->FishDamage['Fish_19'] = [70];
            $this->FishDamage['Fish_20'] = [200];
