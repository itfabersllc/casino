...
namespace VanguardLTE\Games\OceanRulerSW
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->Paytable['Fish_6'] = [5];
            $this->Paytable['Fish_7'] = [
                20,
                25,
                30,
                35,
            ...
            $this->Paytable['Fish_8'] = [6];
            $this->Paytable['Fish_9'] = [7];
            $this->Paytable['Fish_10'] = [8];
            $this->Paytable['Fish_11'] = [9];
            $this->Paytable['Fish_12'] = [10];
            $this->Paytable['Fish_13'] = [12];
            $this->Paytable['Fish_14'] = [15];
            $this->Paytable['Fish_15'] = [18];
            $this->Paytable['Fish_16'] = [20];
            ...
            $this->Paytable['Fish_27'] = ['crabDrill'];
            $this->Paytable['Fish_28'] = ['crabLaser'];
            $this->Paytable['Fish_29'] = ['crabBonus'];
            $this->Paytable['Fish_30'] = ['bomb'];
            $this->FishDamage = [];
            $this->FishDamage['Fish_1'] = 2;
            $this->FishDamage['Fish_2'] = 2;
            $this->FishDamage['Fish_3'] = 10;
            $this->FishDamage['Fish_4'] = 3;
            $this->FishDamage['Fish_5'] = 10;
            $this->FishDamage['Fish_6'] = 3;
            $this->FishDamage['Fish_7'] = 10;
            $this->FishDamage['Fish_8'] = 3;
            $this->FishDamage['Fish_9'] = 3;
            $this->FishDamage['Fish_10'] = 3;
            $this->FishDamage['Fish_11'] = 3;
            $this->FishDamage['Fish_12'] = 3;
            $this->FishDamage['Fish_13'] = 3;
            $this->FishDamage['Fish_14'] = 5;
            $this->FishDamage['Fish_15'] = 5;
            $this->FishDamage['Fish_16'] = 5;
            $this->FishDamage['Fish_17'] = 10;
            $this->FishDamage['Fish_18'] = 15;
            $this->FishDamage['Fish_19'] = 30;
            $this->FishDamage['Fish_20'] = 30;
            $this->FishDamage['Fish_21'] = 5;
            $this->FishDamage['Fish_22'] = 100;
            $this->FishDamage['Fish_23'] = 30;
            $this->FishDamage['Fish_24'] = 30;
            $this->FishDamage['Fish_25'] = 35;
            $this->FishDamage['Fish_26'] = 35;
            $this->FishDamage['Fish_27'] = 100;
            $this->FishDamage['Fish_28'] = 100;
            $this->FishDamage['Fish_29'] = 100;
            $this->FishDamage['Fish_30'] = 100;
            $reel = new GameReel();
            foreach( [
                'reelStrip1',
                'reelStrip2',
