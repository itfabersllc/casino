<?php
namespace VanguardLTE\Games\BugsParadise10000VP
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->Paytable['Fish_5'] = [8];
            $this->Paytable['Fish_6'] = [10];
            $this->Paytable['Fish_7'] = [12];
            $this->Paytable['Fish_8'] = [15];
            $this->Paytable['Fish_9'] = [18];
            $this->Paytable['Fish_10'] = [20];
            $this->Paytable['Fish_11'] = [20];
            $this->Paytable['Fish_12'] = [25];
            $this->Paytable['Fish_13'] = [30];
            $this->Paytable['Fish_14'] = [40];
            $this->Paytable['Fish_15'] = [50];
            $this->Paytable['Fish_16'] = [80];
            $this->Paytable['Fish_17'] = [100];
            $this->Paytable['Fish_18'] = [50];
            $this->Paytable['Fish_19'] = [100];
            $this->Paytable['Fish_20'] = [150];
            $this->Paytable['Fish_21'] = [200];
            ...
            $this->FishDamage['Fish_4'] = [2];
            $this->FishDamage['Fish_5'] = [2];
            $this->FishDamage['Fish_6'] = [2];
            $this->FishDamage['Fish_7'] = [2];
            $this->FishDamage['Fish_8'] = [2];
            ...
            $this->FishDamage['Fish_17'] = [90];
            $this->FishDamage['Fish_18'] = [40];
            $this->FishDamage['Fish_19'] = [100];
            $this->FishDamage['Fish_20'] = [150];
            $this->FishDamage['Fish_21'] = [200];
