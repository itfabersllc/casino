<?php
namespace VanguardLTE\Games\BirdHunter10000VP
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->FishDamage = [];
            $this->FishDamage['Fish_0'] = [2];
            $this->FishDamage['Fish_1'] = [2];
            $this->FishDamage['Fish_2'] = [3];
            $this->FishDamage['Fish_3'] = [4];
            $this->FishDamage['Fish_4'] = [4];
            $this->FishDamage['Fish_5'] = [5];
            $this->FishDamage['Fish_6'] = [6];
            $this->FishDamage['Fish_7'] = [7];
            $this->FishDamage['Fish_8'] = [8];
