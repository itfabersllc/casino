...
namespace VanguardLTE\Games\JokerPokerEGT
{
    class SlotSettings
    {
        ...
        public function GetCombination($cards, $suits, $tipMode = false)
        {
            $cardsS = $cards;
            $suitsS = $suits;
            ...
            if( $combinations[8]['amount'] == 1 && $combinations[8]['cards'][4] == 14 )
            {
                ...
                $combinations[11]['cards'] = $combinations[5]['cards'];
            }
            $pay = 0;
            $holds = [
                0,
            ...
            {
                if( $combinations[$i]['amount'] == 1 && $combinations[$i]['cards'][0] < 13 && $i == 1 )
                {
            ...
            if( $tipMode && $pay == 0 )
            {
                ...
                for( $i = 2; $i <= 14; $i++ )
                {
                    if( $cardsAmount[$i] == 1 && $i >= 13 )
                    {
                        $combinations[1]['amount'] = 1;
                        $combinations[1]['cards'][$hcCount] = $i;
                        $hcCount++;
                    }
                    else if( $cardsAmount[$i] == 2 && $i < 13 )
                    {
                        $combinations[3]['amount'] = 1;
                        $combinations[3]['cards'][0] = $i;
                    }
