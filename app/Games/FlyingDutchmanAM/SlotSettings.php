<?php
namespace VanguardLTE\Games\FlyingDutchmanAM
{
    class SlotSettings
    {
        ...
        public function GetRandomReels()
        {
            ...
            $reelsPos6 = rand(0, count($this->reelStrip6) - 1);
            return $this->HexFormat($reelsPos1) . $this->HexFormat($reelsPos2) . $this->HexFormat($reelsPos3) . $this->HexFormat($reelsPos4) . $this->HexFormat($reelsPos5) . $this->HexFormat($reelsPos6);
        }
