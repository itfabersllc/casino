...
namespace VanguardLTE\Games\SheriffOfNotinghamISB
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->WantedPaytable = [];
            $this->WantedPaytable['SYM_14'] = 1;
            $this->WantedPaytable['SYM_15'] = 5;
            $this->WantedPaytable['SYM_16'] = 10;
            $this->WantedPaytable['SYM_17'] = 20;
            $this->WantedPaytable['SYM_18'] = 30;
            $this->WantedPaytable['SYM_19'] = 50;
            $this->WantedPaytable['SYM_20'] = 1000;
            $reel = new GameReel();
            foreach( [
                'reelStrip1',
                'reelStrip2',
        ...
        public function GetRandomScatterPos($rp, $bonusRand)
        {
            if( $bonusRand == 1 )
            {
                $bsyms = [11];
            ...
            else
            {
                ...
                if( $bonusRand == 1 )
                {
                    ...
                    for( $i = 0; $i < count($reelsId); $i++ )
                    {
                        if( $i == 0 || $i == 2 || $i == 4 )
                        {
                            $prs[$reelsId[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $reelsId[$i]}, $bonusRand);
                        }
                        else
                        {
