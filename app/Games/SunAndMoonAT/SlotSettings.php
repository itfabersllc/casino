<?php
namespace VanguardLTE\Games\SunAndMoonAT
{
    class SlotSettings
    {
        ...
        public function GetRandomScatterPos($rp)
        {
            ...
            {
                if( $rp[$i] == 'symbol_1' || $rp[$i] == 'symbol_2' )
                {
