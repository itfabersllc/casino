<?php
namespace VanguardLTE\Games\FishermansWharf10000VP
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->Paytable['Fish_19'] = [60];
            $this->Paytable['Fish_20'] = [70];
            $this->Paytable['Fish_21'] = [100];
            $this->Paytable['Fish_22'] = [200];
            ...
            $this->FishDamage['Fish_4'] = [5];
            $this->FishDamage['Fish_5'] = [5];
            $this->FishDamage['Fish_6'] = [5];
            $this->FishDamage['Fish_7'] = [5];
            $this->FishDamage['Fish_8'] = [5];
            $this->FishDamage['Fish_9'] = [8];
            $this->FishDamage['Fish_10'] = [8];
            $this->FishDamage['Fish_11'] = [8];
