<?php
namespace VanguardLTE\Games\MedusaMonstersPT
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $rId, $slotEvent)
        {
            $this->reelStrip1 = $this->reelsIndexArr[$rId][0];
            $this->reelStrip2 = $this->reelsIndexArr[$rId][1];
            $this->reelStrip3 = $this->reelsIndexArr[$rId][2];
            $this->reelStrip4 = $this->reelsIndexArr[$rId][3];
            $this->reelStrip5 = $this->reelsIndexArr[$rId][4];
            $this->reelStrip6 = $this->reelsIndexArr[$rId][5];
            $game = $this->game;
            if( $winType != 'bonus' )
            {
                $prs = [];
