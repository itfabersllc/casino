<?php
namespace VanguardLTE\Games\LotusLampKA
{
    class SlotSettings
    {
            ...
            else
            {
                ...
                if( $bonusType == 1 )
                {
                    ...
                    for( $i = 0; $i < count($reelsId); $i++ )
                    {
                        if( $i < $scattersCnt )
                        {
                            $prs[$reelsId[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $reelsId[$i]}, '5');
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    for( $i = 0; $i < count($reelsId); $i++ )
                    {
                        if( $i < $scattersCnt )
                        {
                            $prs[$reelsId[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $reelsId[$i]}, '12');
                        }
                        else
                        {
                            $prs[$reelsId[$i]] = rand(0, count($this->{'reelStrip' . $reelsId[$i]}) - 3);
