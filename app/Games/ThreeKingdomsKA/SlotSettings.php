<?php
namespace VanguardLTE\Games\ThreeKingdomsKA
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->scaleMode = 0;
            $this->numFloat = 0;
            $this->Paytable['Fish_22'] = 2;
            $this->Paytable['Fish_21'] = 3;
            $this->Paytable['Fish_20'] = 4;
            $this->Paytable['Fish_19'] = 5;
            $this->Paytable['Fish_18'] = 6;
            $this->Paytable['Fish_17'] = 7;
            $this->Paytable['Fish_16'] = 8;
            $this->Paytable['Fish_15'] = 9;
            $this->Paytable['Fish_14'] = 10;
            $this->Paytable['Fish_13'] = 12;
            $this->Paytable['Fish_12'] = 15;
            $this->Paytable['Fish_11'] = 18;
            $this->Paytable['Fish_10'] = 20;
            $this->Paytable['Fish_09'] = 25;
            $this->Paytable['Fish_08'] = 30;
            $this->Paytable['Fish_07'] = 40;
            $this->Paytable['Fish_06'] = 80;
            $this->Paytable['Fish_05'] = 100;
            $this->Paytable['Fish_04'] = 150;
            $this->Paytable['Fish_03'] = 200;
            $this->Paytable['Fish_02'] = 200;
            $this->Paytable['Fish_01'] = 20;
            $reel = new GameReel();
            foreach( [
                'reelStrip1',
                'reelStrip2',
