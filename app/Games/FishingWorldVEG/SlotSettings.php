...
namespace VanguardLTE\Games\FishingWorldVEG
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->scaleMode = 0;
            $this->numFloat = 0;
            $this->Paytable['Fish_1'] = [40];
            $this->Paytable['Fish_2'] = [15];
            $this->Paytable['Fish_3'] = [2];
            $this->Paytable['Fish_4'] = [
                100,
                300
            ];
            $this->Paytable['Fish_5'] = [7];
            $this->Paytable['Fish_6'] = [10];
            $this->Paytable['Fish_7'] = [3];
            $this->Paytable['Fish_8'] = [30];
            $this->Paytable['Fish_9'] = [60];
            $this->Paytable['Fish_10'] = [6];
            $this->Paytable['Fish_11'] = [5];
            $this->Paytable['Fish_12'] = [20];
            $this->Paytable['Fish_13'] = [5];
            $this->Paytable['Fish_14'] = [20];
            $this->Paytable['Fish_15'] = [4];
            $this->Paytable['Fish_16'] = [12];
            $this->Paytable['Fish_17'] = [30];
            $this->Paytable['Fish_18'] = [50];
            $this->Paytable['Fish_19'] = [9];
            $this->Paytable['Fish_20'] = [18];
            $this->Paytable['Fish_21'] = [20];
            $this->Paytable['Fish_22'] = [15];
            $this->Paytable['Fish_23'] = [0];
            $this->Paytable['Fish_24'] = [0];
            $this->Paytable['Fish_25'] = [80];
            $this->Paytable['Fish_26'] = [50];
            $this->Paytable['Fish_27'] = [30];
            $this->Paytable['Fish_28'] = [30];
            $this->Paytable['Fish_29'] = [0];
            $this->Paytable['Fish_30'] = [
                300,
                1000
            ];
            $this->FishDamage = [];
            $this->FishDamage['Fish_1'] = [30];
            $this->FishDamage['Fish_2'] = [8];
            $this->FishDamage['Fish_3'] = [3];
            $this->FishDamage['Fish_4'] = [50];
            $this->FishDamage['Fish_5'] = [5];
            $this->FishDamage['Fish_6'] = [8];
            $this->FishDamage['Fish_7'] = [3];
            $this->FishDamage['Fish_8'] = [15];
            $this->FishDamage['Fish_9'] = [40];
            $this->FishDamage['Fish_10'] = [4];
            $this->FishDamage['Fish_11'] = [3];
            $this->FishDamage['Fish_12'] = [8];
            $this->FishDamage['Fish_13'] = [4];
            $this->FishDamage['Fish_14'] = [10];
            $this->FishDamage['Fish_15'] = [3];
            $this->FishDamage['Fish_16'] = [8];
            $this->FishDamage['Fish_17'] = [18];
            $this->FishDamage['Fish_18'] = [25];
            $this->FishDamage['Fish_19'] = [5];
            $this->FishDamage['Fish_20'] = [10];
            $this->FishDamage['Fish_21'] = [12];
            $this->FishDamage['Fish_22'] = [10];
            $this->FishDamage['Fish_23'] = [0];
            $this->FishDamage['Fish_24'] = [0];
            $this->FishDamage['Fish_25'] = [60];
            $this->FishDamage['Fish_26'] = [35];
            $this->FishDamage['Fish_27'] = [20];
            $this->FishDamage['Fish_28'] = [20];
            $this->FishDamage['Fish_29'] = [0];
            $this->FishDamage['Fish_30'] = [300];
            $reel = new GameReel();
            foreach( [
                'reelStrip1',
                'reelStrip2',
