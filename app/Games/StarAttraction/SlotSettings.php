<?php
namespace VanguardLTE\Games\StarAttraction
{
    class SlotSettings
    {
        ...
        public $slotRandomizeWilds = null;
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->slotRandomizeWilds = true;
            if( $this->slotRandomizeWilds )
            {
                $randomWild = rand(1, 2);
                if( $randomWild == 1 )
                {
                ...
                else
                {
                    ...
                    ] as $reelStrip )
                    {
                        ...
                        {
                            $this->$reelStrip = $reel->reelsStrip[$reelStrip];
                            foreach( $this->$reelStrip as &$item )
                            {
                                if( $item == 'P_1' )
                                {
                                    $item = 'P_2';
