<?php
namespace VanguardLTE\Games\CrazyMonkey2IG
{
    class SlotSettings
    {
        ...
        public function Bonus($bet, $fuseBet)
        {
            ...
            {
                $superWins0 = 50;
                $superWin = $superWins0 * $bet;
                $bWin += $superWin;
                $strOut = '"BonusWins":[' . implode(',', $bStr) . '],"SuperWin":{"Coef":' . $superWins0 . ',"Win":' . $superWin . '},';
            }
            else
            {
        ...
        public function SuperWin($bet)
        {
            ...
            $bWin += $cwin;
            $strOut = '"SuperWin":{"Coef":' . $superWins[0] . ',"Win":' . $cwin . '},';
            return [
                'win' => $bWin,
                'info' => $strOut,
                'supercoef' => $superWins[0]
            ];
        }
