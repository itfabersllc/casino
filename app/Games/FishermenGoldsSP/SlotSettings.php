...
namespace VanguardLTE\Games\FishermenGoldsSP
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->scaleMode = 0;
            $this->numFloat = 0;
            $this->Paytable['Fish_1'] = [1];
            $this->Paytable['Fish_2'] = [2];
            $this->Paytable['Fish_3'] = [3];
            $this->Paytable['Fish_4'] = [5];
            $this->Paytable['Fish_5'] = [6];
            $this->Paytable['Fish_6'] = [7];
            $this->Paytable['Fish_7'] = [10];
            $this->Paytable['Fish_8'] = [14];
            $this->Paytable['Fish_9'] = [17];
            $this->Paytable['Fish_10'] = [25];
            $this->Paytable['Fish_11'] = [30];
            $this->Paytable['Fish_12'] = [40];
            $this->Paytable['Fish_13'] = [50];
            $this->Paytable['Fish_14'] = [75];
            $this->Paytable['Fish_15'] = [100];
            $this->Paytable['Fish_16'] = [175];
            $this->Paytable['Fish_17'] = [175];
            $this->Paytable['Fish_18'] = [175];
            $this->Paytable['Fish_19'] = [250];
            $this->Paytable['Fish_20'] = [250];
            $this->Paytable['Fish_21'] = [250];
            $this->Paytable['Fish_22'] = [400];
            $this->Paytable['Fish_23'] = [400];
            $this->Paytable['Fish_24'] = [400];
            $this->Paytable['Fish_25'] = [500];
            $this->Paytable['Fish_26'] = [500];
            $this->Paytable['Fish_27'] = [500];
            $this->Paytable['Fish_28'] = [750];
            $this->Paytable['Fish_29'] = [750];
            $this->Paytable['Fish_30'] = [750];
            $this->FishDamage = [];
            $this->FishDamage['Fish_1'] = [2];
            $this->FishDamage['Fish_2'] = [2];
            $this->FishDamage['Fish_3'] = [2];
            $this->FishDamage['Fish_4'] = [3];
            $this->FishDamage['Fish_5'] = [3];
            $this->FishDamage['Fish_6'] = [3];
            $this->FishDamage['Fish_7'] = [3];
            $this->FishDamage['Fish_8'] = [5];
            $this->FishDamage['Fish_9'] = [10];
            $this->FishDamage['Fish_10'] = [10];
            $this->FishDamage['Fish_11'] = [15];
            $this->FishDamage['Fish_12'] = [15];
