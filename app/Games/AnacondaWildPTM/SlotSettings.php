<?php
namespace VanguardLTE\Games\AnacondaWildPTM
{
    class SlotSettings
    {
        ...
        public function SaveLogReport($spinSymbols, $bet, $lines, $win, $slotState)
        {
            ...
            if( $slotState == 'bet' )
            {
                $this->user->update_level('bet', $bet * 25 * $this->CurrentDenom);
            }
            if( $slotState != 'freespin' )
            {
                $game->increment('stat_in', $bet * 25 * $this->CurrentDenom);
            }
            $game->increment('stat_out', $win * $this->CurrentDenom);
            $game->tournament_stat($slotState, $this->user->id, $bet * 25 * $this->CurrentDenom, $win * $this->CurrentDenom);
