<?php
namespace VanguardLTE\Games\MayaTreasureMN
{
    class SlotSettings
    {
            ...
            else
            {
                ...
                if( $bsym == '10' )
                {
                    ...
                    ] as $index => $reelStrip )
                    {
                        if( is_array($this->$reelStrip) && count($this->$reelStrip) > 0 )
                        {
                            $prs[$index + 1] = $this->GetRandomScatterPos($this->$reelStrip, $bsym);
                            $reelsId[] = $index + 1;
                        }
                    }
                    ...
                    for( $i = 0; $i < count($reelsId); $i++ )
                    {
                        if( $i < $scattersCnt )
                        {
                            $prs[$reelsId[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $reelsId[$i]}, $bsym);
                        }
                        else
                        {
