...
namespace VanguardLTE\Games\FlyJetSW
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->numFloat = 0;
            $this->Paytable = [];
            $this->Paytable['Air_0'] = rand(35, 60);
            $this->Paytable['Air_1'] = rand(12, 30);
            $this->Paytable['Air_2'] = rand(8, 15);
            $this->Paytable['Air_3'] = rand(6, 10);
            $this->Paytable['Air_4'] = rand(2, 8);
            $this->Paytable['Air_5'] = 0;
            $this->Paytable['Air_6'] = 0;
            $this->Damage = [];
            $this->Damage['Air_0'] = 50;
            $this->Damage['Air_1'] = 40;
            $this->Damage['Air_2'] = 20;
            $this->Damage['Air_3'] = 8;
            $this->Damage['Air_4'] = 5;
            $this->Damage['Air_5'] = 10;
            $this->Damage['Air_6'] = 50;
            $reel = new GameReel();
            foreach( [
                'reelStrip1',
                'reelStrip2',
