<?php
namespace VanguardLTE\Games\Illusionist
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->slotWinLineMode = 'Left';
            $this->slotBonusLimitStart = 2;
            $this->slotBonusMaxLimitStart = 2;
            $this->increaseFreeSpinsCount = 0;
            $this->increaseFreeSpinsMpl = 0;
            $this->slotBonusRetriger = false;
            $this->slotBonusReelsFixed = [
                'countFixedReels' => 2,
                'reel1' => 'fixed',
                'reel5' => 'fixed'
            ];
...
//end slotsounds update
        ...
        public function GetRandomScatterPos($rp)
        {
            ...
            {
                if( $rp[$i] == 'SCAT' && $rp[$i + 1] == 'SCAT' && $rp[$i + 2] == 'SCAT' )
                {
