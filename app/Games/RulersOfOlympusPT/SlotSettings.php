<?php
namespace VanguardLTE\Games\RulersOfOlympusPT
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $slotEvent, $bonusType)
        {
            ...
            if( $winType != 'bonus' && $winType != 'bonus2' )
            {
                $prs = [];
                foreach( [
                    'reelStrip1',
