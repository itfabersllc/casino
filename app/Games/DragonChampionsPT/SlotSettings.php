<?php
namespace VanguardLTE\Games\DragonChampionsPT
{
    class SlotSettings
    {
        ...
        public function GetReelStrips0($rIndex, $type)
        {
            $reelsIndexArr = [
                [],
                [],
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            if( $winType != 'bonus' )
            {
                ...
                ] as $index => $reelStrip )
                {
                    ...
                    {
                        $prs[$index + 1] = mt_rand(0, count($this->$reelStrip) - 10);
                    }
                }
            }
            else
            {
                ...
                for( $i = 0; $i < count($reelsId); $i++ )
                {
                    ...
                    {
                        $prs[$reelsId[$i]] = rand(0, count($this->{'reelStrip' . $reelsId[$i]}) - 10);
                    }
                }
            }
            $reel = [
