...
namespace VanguardLTE\Games\FishingWarSG
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->Paytable['Fish_9'] = [11];
            $this->Paytable['Fish_10'] = [12];
            $this->Paytable['Fish_11'] = [13];
            $this->Paytable['Fish_12'] = [15];
            $this->Paytable['Fish_13'] = [18];
            ...
            $this->Paytable['Fish_101'] = [
                30,
                100
            ];
            $this->Paytable['Fish_102'] = [
                10,
                10
            ];
            $this->Paytable['Fish_103'] = [
                30,
                100
            ];
            $this->Paytable['Fish_104'] = [
                100,
                688
            ];
            $this->Paytable['Fish_105'] = [
                100,
                888
            ];
            $this->Paytable['Fish_106'] = [
                30,
                300
            ];
            $this->Paytable['Fish_107'] = [
                100,
                488
            ];
            $this->Paytable['Fish_108'] = [
                100,
                688
            ];
            $this->Paytable['Fish_109'] = [
                100,
                888
            ];
