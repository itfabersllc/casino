...
namespace VanguardLTE\Games\TheWizardOfOZMN
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->game = $game;
            $this->MaxWin = !empty($this->shop) ? $this->shop->max_win : 200;
            $this->increaseRTP = 1;
            ...
            $this->Denominations = array_slice($this->Denominations, 0, 8);
        ...
        public function GetSymPositions($reels)
        {
            $swm_ = [
                0,
                0,
            ...
            $reels['reel1'] = array_reverse($reels['reel1']);
            $reels['reel2'] = array_reverse($reels['reel2']);
            $reels['reel3'] = array_reverse($reels['reel3']);
            $reels['reel4'] = array_reverse($reels['reel4']);
            $reels['reel5'] = array_reverse($reels['reel5']);
            for( $p = 7; $p >= 0; $p-- )
            {
                if( $reels['reel1'][$p] == -1 )
                {
                ...
                if( $reels['reel1'][$p] == -1 && $reels['reel2'][$p] == -1 )
                {
                    $swm_[$p] = 3;
                }
                if( $reels['reel3'][$p] == -1 )
                ...
                if( $reels['reel1'][$p] == -1 && $reels['reel3'][$p] == -1 )
                {
                    $swm_[$p] = 5;
                }
                if( $reels['reel2'][$p] == -1 && $reels['reel3'][$p] == -1 )
                {
                    $swm_[$p] = 6;
                }
                if( $reels['reel1'][$p] == -1 && $reels['reel2'][$p] == -1 && $reels['reel3'][$p] == -1 )
                {
                    $swm_[$p] = 7;
                }
                if( $reels['reel4'][$p] == -1 )
                ...
                if( $reels['reel1'][$p] == -1 && $reels['reel4'][$p] == -1 )
                {
                    $swm_[$p] = 9;
                }
                if( $reels['reel2'][$p] == -1 && $reels['reel4'][$p] == -1 )
                {
                    $swm_[$p] = 10;
                }
                if( $reels['reel1'][$p] == -1 && $reels['reel2'][$p] == -1 && $reels['reel4'][$p] == -1 )
                {
                    $swm_[$p] = 11;
                }
                if( $reels['reel3'][$p] == -1 && $reels['reel4'][$p] == -1 )
                {
                    $swm_[$p] = 12;
                }
                if( $reels['reel1'][$p] == -1 && $reels['reel3'][$p] == -1 && $reels['reel4'][$p] == -1 )
                {
                    $swm_[$p] = 13;
                }
                if( $reels['reel2'][$p] == -1 && $reels['reel3'][$p] == -1 && $reels['reel4'][$p] == -1 )
                {
                    $swm_[$p] = 14;
                }
                if( $reels['reel1'][$p] == -1 && $reels['reel2'][$p] == -1 && $reels['reel3'][$p] == -1 && $reels['reel4'][$p] == -1 )
                {
                    $swm_[$p] = 15;
                }
                if( $reels['reel5'][$p] == -1 )
                ...
                if( $reels['reel1'][$p] == -1 && $reels['reel5'][$p] == -1 )
                {
                    $swm_[$p] = 17;
                }
                if( $reels['reel2'][$p] == -1 && $reels['reel5'][$p] == -1 )
                {
                    $swm_[$p] = 18;
                }
                if( $reels['reel1'][$p] == -1 && $reels['reel2'][$p] == -1 && $reels['reel5'][$p] == -1 )
                {
                    $swm_[$p] = 19;
                }
                if( $reels['reel3'][$p] == -1 && $reels['reel5'][$p] == -1 )
                {
                    $swm_[$p] = 20;
                }
                if( $reels['reel1'][$p] == -1 && $reels['reel3'][$p] == -1 && $reels['reel5'][$p] == -1 )
                {
                    $swm_[$p] = 21;
                }
                if( $reels['reel2'][$p] == -1 && $reels['reel3'][$p] == -1 && $reels['reel5'][$p] == -1 )
                {
                    $swm_[$p] = 22;
                }
                if( $reels['reel1'][$p] == -1 && $reels['reel2'][$p] == -1 && $reels['reel3'][$p] == -1 && $reels['reel5'][$p] == -1 )
                {
                    $swm_[$p] = 23;
                }
                if( $reels['reel4'][$p] == -1 && $reels['reel5'][$p] == -1 )
                {
                    $swm_[$p] = 24;
                }
                if( $reels['reel1'][$p] == -1 && $reels['reel4'][$p] == -1 && $reels['reel5'][$p] == -1 )
                {
                    $swm_[$p] = 25;
                }
                if( $reels['reel2'][$p] == -1 && $reels['reel4'][$p] == -1 && $reels['reel5'][$p] == -1 )
                {
                    $swm_[$p] = 26;
                }
                if( $reels['reel1'][$p] == -1 && $reels['reel2'][$p] == -1 && $reels['reel4'][$p] == -1 && $reels['reel5'][$p] == -1 )
                {
                    $swm_[$p] = 27;
                }
                if( $reels['reel3'][$p] == -1 && $reels['reel4'][$p] == -1 && $reels['reel5'][$p] == -1 )
                {
                    $swm_[$p] = 28;
                }
                if( $reels['reel1'][$p] == -1 && $reels['reel3'][$p] == -1 && $reels['reel4'][$p] == -1 && $reels['reel5'][$p] == -1 )
                {
                    $swm_[$p] = 29;
                }
                if( $reels['reel2'][$p] == -1 && $reels['reel3'][$p] == -1 && $reels['reel4'][$p] == -1 && $reels['reel5'][$p] == -1 )
                {
                    $swm_[$p] = 30;
                }
                if( $reels['reel1'][$p] == -1 && $reels['reel2'][$p] == -1 && $reels['reel3'][$p] == -1 && $reels['reel4'][$p] == -1 && $reels['reel5'][$p] == -1 )
                {
                    $swm_[$p] = 31;
                }
            }
            $swm = $swm_[7] + (32 * $swm_[6]) + (1024 * $swm_[5]) + (32768 * $swm_[4]) + (1048576 * $swm_[3]) + (33554432 * $swm_[2]) + (1073741824 * $swm_[1]) + (34359738368 * $swm_[0]);
            return $swm;
        }
        ...
        public function GetRandomScatterPos($rp)
        {
            ...
            {
                if( $rp[$i] == '11' && isset($rp[$i + 5]) && isset($rp[$i - 5]) )
                {
                    array_push($rpResult, $i - 6);
                    array_push($rpResult, $i - 7);
                    array_push($rpResult, $i - 8);
                }
            }
            shuffle($rpResult);
            if( !isset($rpResult[0]) )
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            if( $winType != 'bonus' )
            {
                ...
                ] as $index => $reelStrip )
                {
                    ...
                    {
                        $prs[$index + 1] = mt_rand(0, count($this->$reelStrip) - 14);
                    }
                }
            }
            else
            {
                ...
                for( $i = 0; $i < count($reelsId); $i++ )
                {
                    ...
                    {
                        $prs[$reelsId[$i]] = rand(0, count($this->{'reelStrip' . $reelsId[$i]}) - 14);
                    }
                }
            }
            $reel = [
            ...
            foreach( $prs as $index => $value )
            {
                ...
                $reel['reel' . $index][7] = $key[$value + 6];
                $reel['reel' . $index][8] = $key[$value + 7];
                $reel['reel' . $index][9] = $key[$value + 8];
                $reel['reel' . $index][10] = $key[$value + 9];
                $reel['reel' . $index][11] = $key[$value + 10];
                $reel['reel' . $index][12] = $key[$value + 11];
                $reel['reel' . $index][13] = $key[$value + 12];
                $reel['reel' . $index][14] = $key[$value + 13];
                $reel['reel' . $index][15] = '';
                $reel['rp'][] = $value;
            }
            return $reel;
