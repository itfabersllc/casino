            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <span class="close" data-bs-dismiss="modal" type="button" aria-label="Close">
                        ...
                        <form class="verify-gcaptcha" action="{{ route('login') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group d-flex justify-content-between align-items-center">
                                ...
                                <a class="t-link--base sm-text" href="{{ route('password.request') }}">@lang('Forgot Password?')</a>
                            </div>
                            ...
                            <div class="d-flex justify-content-center align-items-center gap-2 mt-2">
                                ...
                                <a class="t-link d-inline-block t-link--base base-clr sm-text lh-1 text-center text-end" href="{{ route('register') }}">@lang('Create account')</a>
                            </div>
                        </form>
