...
<html>
<head>
	<base href="/games/AgeOfGodsKingofOlympusPTM/platform/">
    ...
    if( !sessionStorage.getItem('sessionId') ){
		...
		var qstr='/?game=kolymp&real=1&language=en&lang=en&hub=1&username=PLAYER&temptoken=_';
...
<script type="text/javascript">
  ...
  localStorage.setItem('SESSIONS_PLAYER', 'kolymp=AgeOfGodsKingofOlympusPTM');
