...
<head>
	...
	<base href="/games/VirtualRouletteEGT/html5/" target="_blank" >
    ...
    XmlHttpRequest.send(null);
		...
		sslHost=true;
         ...
         var gameName='VirtualRouletteEGT';
		$(function(){
...
<body onload="injectCSS()"  style="display:flex;    justify-content: center;     align-items: center;position:fixed;">
</body>
</html>
