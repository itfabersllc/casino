...
<html>
<head>
	<base href="/games/JacksOrBetterMHPTM/platform/">
    <meta http-equiv="X-UA-Compatible" content="IE=edge"/>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="msapplication-tap-highlight" content="no"/>
    <meta name="viewjb_mhrt"
          content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, target-densitydpi=device-dpi, user-scalable=no, viewjb_mhrt-fit=cover"
          id="meta-viewjb_mhrt">
    ...
    if( !sessionStorage.getItem('sessionId') ){
		...
		var qstr='/?game=jb_mh&real=1&language=en&lang=en&hub=1&username=PLAYER&temptoken=_';	
...
/*--------*/	
    ...
    <script type="text/javascript" src="js/viewjb_mhrtJs.js"></script>
...
<body onload="injectCSS()"  style="display:flex;    justify-content: center;     align-items: center;background-color: #000;overflow:hidden;" class="noBranding">
<div id="size-handler"></div>
<div id='app' style="background-color: #000;overflow:hidden;">
    <div class='scalable' id="viewjb_mhrt">
...
<script type="text/javascript">
  ...
  localStorage.setItem('SESSIONS_PLAYER', 'jb_mh=JacksOrBetterMHPTM');
