...
<html>
<head>
	<base href="/games/BlackjackSurrenderPTM/platform/">
    ...
    if( !sessionStorage.getItem('sessionId') ){
		...
		var qstr='/?game=bjsd2&real=1&language=en&lang=en&hub=1&username=PLAYER&temptoken=_';	
...
<script type="text/javascript">
  ...
  localStorage.setItem('SESSIONS_PLAYER', 'bjsd2=BlackjackSurrenderPTM');
