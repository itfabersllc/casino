...
<html>
<head>
	<base href="/games/ZhaoCaiJinBaoJPPTM/platform/">
    ...
    if( !sessionStorage.getItem('sessionId') ){
		...
		var qstr='/?game=zcjbjp&real=1&language=en&lang=en&hub=1&username=PLAYER&temptoken=_';	
...
<script type="text/javascript">
  ...
  localStorage.setItem('SESSIONS_PLAYER', 'zcjbjp=ZhaoCaiJinBaoJPPTM');
