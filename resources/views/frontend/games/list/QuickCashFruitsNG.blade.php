...
<head>
    ...
    <meta charset="UTF-8">
  	<base href="/games/QuickCashFruitsNG/app/quickCashFruits.110/"> 
    <meta name="viewport" content="initial-scale=1, maximum-scale=1, user-scalable=no">
    <meta name="robots" content="noindex, nofollow">
    <title>{{$game->title}}</title>
    <link href="../../favicon.ico" rel="icon" type="image/x-icon" />
	 <script type="text/javascript" src="index.js?cfa8a9b6052ac45261eb"></script>
	<script>
    ...
    if( !sessionStorage.getItem('sessionId') ){
		...
		var qstr='/?launcher=true&sfx_570811222=1616238930881&commonVersion=(build%20144)&game=353&userId=003403186056&wshost=&quality=high&lang=en&noframe=yes';	
