...
<script src="cdn/html5/u_rd_dimsumprize/_current_version/src/js/src.js" type="text/javascript"></script>
...
<script>
    ...
    function getGamePathURL() {
        return "/games/{{ $game->name }}/cdn/html5/u_rd_dimsumprize/_current_version" + "/";
    }
