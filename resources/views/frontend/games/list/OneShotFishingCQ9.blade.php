...
<base href="/games/{{ $game->name }}/AT01/">
    <link rel="icon" type="image/x-icon" href="res/_favicon.ico" />
...
<canvas id="gameCanvas" width="944" height="1680" style="z-index: -1"></canvas>
<script>
...
var GameName='{{ $game->name }}';
    ...
    if(url.searchParams.has('language'))
    {
        ...
        if(param == 'zh-cn')
            document.getElementById('title').innerHTML = '一炮捕鱼';
        else
            document.getElementById('title').innerHTML = 'OneShotFishing';
    }else{
        document.getElementById('title').innerHTML = 'OneShotFishing';
    }
