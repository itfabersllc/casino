...
<html>
<head>
	<base href="/games/AgeOfTheGodsGodOfStormsPTM/platform/">
    ...
    if( !sessionStorage.getItem('sessionId') ){
		...
		var qstr='/?game=aeolus&real=1&language=en&lang=en&hub=1&username=PLAYER&temptoken=_';
...
<script type="text/javascript">
  ...
  localStorage.setItem('SESSIONS_PLAYER', 'aeolus=AgeOfTheGodsGodOfStormsPTM');
