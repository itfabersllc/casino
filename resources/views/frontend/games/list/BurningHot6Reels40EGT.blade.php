...
<head>
	...
	<base href="/games/BurningHot6Reels40EGT/html5/" target="_blank" >
    ...
    XmlHttpRequest.send(null);
		...
		sslHost=true;
         ...
         var gameName='BurningHot6Reels40EGT';
		$(function(){
...
if(device.desktop()){
			...
			$.ajax({
				type: "GET",
				crossDomain: "false",
				url: "../init/init_desktop_html_test.js",
				dataType: "script",
