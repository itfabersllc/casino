...
Route::get('/update-game-statuses', function() {
    ...
    foreach ($games as $game) {
        ...
        if (File::exists($folderPath) && File::isDirectory($folderPath)) {
            ...
            // Set status to 0 if the folder does not exist
            $game->status = 0;
        }

        $game->save(); // Save the status update
    }
...
Route::namespace('Frontend')->middleware(['siteisclosed', 'checker'])->group(function () {
    ...
    */
    ...
    Route::get('game_page', [
        'as' => 'frontend.game.game_page',
        'uses' => 'GamesController@getGamePageNation'
    ]);
    ...
    Route::post('sports/get_prePopular', [
...
Route::prefix('backend')->middleware(['checker'])->group(function () {
...
Route::prefix('backend')->middleware(['auth', 'checker'])->group(function () {
    Route::namespace('Backend')->group(function () {
        ...
        */
        ...
        Route::get('pincodes/{pincode}/edit', [
            ...
            'middleware' => 'permission:pincodes.edit'
        ]);
        ...
        Route::post('credits/create', [
            'as' => 'backend.credit.store',
            'uses' => 'CreditController@store',
        ]);
        Route::get('credits/{credit}/edit', [
            'as' => 'backend.credit.edit',
            'uses' => 'CreditController@edit',
        ]);
        Route::post('credits/{credit}/update', [
            'as' => 'backend.credit.update',
            'uses' => 'CreditController@update',
        ]);
        Route::delete('credits/{credit}/delete', [
            'as' => 'backend.credit.delete',
            'uses' => 'CreditController@delete',
        ]);

        Route::get('credits/{credit}/buy', [
            'as' => 'backend.credit.buy',
            'uses' => 'CreditController@buy',
        ]);
        Route::get('credits/{credit}/buy/{system}', [
            'as' => 'backend.credit.payment',
            'uses' => 'CreditController@payment',
        ]);
        ...
        Route::get('tournaments/{tournament}/edit', [
            'as' => 'backend.tournament.edit',
            'uses' => 'TournamentController@edit',
            'middleware' => 'permission:tournaments.edit'
        ]);
        Route::post('tournaments/{tournament}/update', [
        ...
        Route::delete('tournaments/{tournament}/delete', [
            ...
            'uses' => 'TournamentController@delete',
            'middleware' => 'permission:tournaments.delete'
        ]);
        Route::get('tournaments/games.json', [
            'as' => 'backend.tournament.games',
            'uses' => 'TournamentController@games',
            'middleware' => 'permission:tournaments.manage'
        ]);
        ...
        Route::get('smsbonuses', [
            'as' => 'backend.sms_bonus.list',
            'uses' => 'SMSBonusController@index',
            'middleware' => 'permission:sms_bonuses.manage'
        ]);
        Route::get('smsbonuses/create', [
            'as' => 'backend.sms_bonus.create',
            'uses' => 'SMSBonusController@create',
            'middleware' => 'permission:sms_bonuses.add'
        ]);
        Route::post('smsbonuses/create', [
            'as' => 'backend.sms_bonus.store',
            'uses' => 'SMSBonusController@store',
            'middleware' => 'permission:sms_bonuses.add'
        ]);
        Route::get('smsbonuses/{sms_bonus}/edit', [
            'as' => 'backend.sms_bonus.edit',
            'uses' => 'SMSBonusController@edit',
            'middleware' => 'permission:sms_bonuses.edit'
        ]);
        Route::post('smsbonuses/{sms_bonus}/update', [
            'as' => 'backend.sms_bonus.update',
            'uses' => 'SMSBonusController@update',
            'middleware' => 'permission:sms_bonuses.edit'
        ]);
        Route::delete('smsbonuses/{sms_bonus}/delete', [
            'as' => 'backend.sms_bonus.delete',
            'uses' => 'SMSBonusController@delete',
            'middleware' => 'permission:sms_bonuses.delete'
        ]);
        Route::get('smsbonuses/status/{status}', [
            'as' => 'backend.sms_bonus.status',
            'uses' => 'SMSBonusController@status',
        ]);
        ...
        Route::get('faq/{faq}/edit', [
            'as' => 'backend.faq.edit',
            'uses' => 'FaqsController@edit',
            'middleware' => 'only_for_admin',
        ]);
        Route::post('faq/{faq}/update', [
            'as' => 'backend.faq.update',
            'uses' => 'FaqsController@update',
            'middleware' => 'only_for_admin',
        ]);
        Route::delete('faq/{faq}/delete', [
        ...
        Route::get('activity', [
            ...
            'middleware' => 'permission:activity.system',
        ]);

        Route::get('activity/system', [
            'as' => 'backend.activity.system',
            'uses' => 'ActivityController@system',
            'middleware' => 'permission:activity.system',
        ]);
        ...
        Route::get('activity/user', [
            ...
            'middleware' => 'permission:activity.user',
        ]);
        ...
        Route::get('sms_mailings', [
            'as' => 'backend.sms_mailing.list',
            'uses' => 'SMSMailingController@index',
            'middleware' => 'only_for_admin'
        ]);
        Route::get('sms_mailings/create', [
            'as' => 'backend.sms_mailing.create',
            'uses' => 'SMSMailingController@create',
            'middleware' => 'only_for_admin'
        ]);
        Route::post('sms_mailings/create', [
            'as' => 'backend.sms_mailing.store',
            'uses' => 'SMSMailingController@store',
            'middleware' => 'only_for_admin'
        ]);
        Route::get('sms_mailings/{mailing}/edit', [
            'as' => 'backend.sms_mailing.edit',
            'uses' => 'SMSMailingController@edit',
            'middleware' => 'only_for_admin'
        ]);
        Route::post('sms_mailings/{mailing}/update', [
            'as' => 'backend.sms_mailing.update',
            'uses' => 'SMSMailingController@update',
            'middleware' => 'only_for_admin'
        ]);
        Route::delete('sms_mailings/{mailing}/delete', [
            'as' => 'backend.sms_mailing.delete',
            'uses' => 'SMSMailingController@delete',
            'middleware' => 'only_for_admin'
        ]);
        ...
        Route::get('support/create', [
            ...
            'middleware' => 'permission:tickets.add'
        ]);
        ...
        Route::post('support/{ticket}/answer', [
            'as' => 'backend.support.answer',
            'uses' => 'SupportController@answer',
        ]);
        Route::get('/support/{ticket}', [
            'as' => 'backend.support.view',
            'uses' => 'SupportController@view'
        ]);
        Route::put('support/{ticket}/close', [
