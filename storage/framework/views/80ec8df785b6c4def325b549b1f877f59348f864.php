...
<base href="/games/<?php echo e($game->name); ?>/">
    ...
    XmlHttpRequest.send(null);
        ...
        }</style><meta name="apple-mobile-web-app-capable" content="yes"><meta name="mobile-web-app-capable" content="yes"><link rel="stylesheet" type="text/css" href="css/main.css"><link rel="stylesheet" type="text/css" href="css/cma/cma.css"><link rel="stylesheet" type="text/css" href="css/modal.css"><script src="src/bundle.js"></script></head><body><div id="viewportMeasuringContainer"></div><div id="gameFullScreenContainer"><div id="orientationFullScreen"></div></div><div id="fingerUpGestureContainer"><div id="fingerUpGesture"></div></div><div id="orientation"></div></body><script rel="javascript" type="text/javascript" src="/games/<?php echo e($game->name); ?>/device.js"></script>
<script rel="javascript" type="text/javascript" src="/games/<?php echo e($game->name); ?>/addon.js"></script></html><?php /**PATH C:\OSPanel\domains\cas.loc\resources\views/frontend/games/list/LuckyKenoPP.blade.php ENDPATH**/ ?>