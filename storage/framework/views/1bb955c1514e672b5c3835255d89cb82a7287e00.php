...
<iframe id='game' style="margin:0px;border:0px;width:1300px;height:100vh;max-width:100%"
        src='/games/Monkeys/gs2c/html5Game.html?lang=en&cur=<?php if( auth()->user()->present()->shop ): ?><?php echo e(auth()->user()->present()->shop->currency); ?><?php endif; ?>&gameSymbol=vs1dragon8&websiteUrl=&lobbyURL='
        allowfullscreen>
...
<?php /**PATH /home/itfabers/casino.dev.itfabers.com/resources/views/frontend/games/list/Monkeys.blade.php ENDPATH**/ ?>