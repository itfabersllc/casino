        ...
        <div class="modal__content">
            ...
            <div class="modal__kassa">
                ...
                <div class="modal__kassa-row">
                    ...
                    <?php if( Auth::check() && settings('payment_interkassa') &&
                    ...
                    <?php if( Auth::check() && settings('payment_coinbase') &&
                    ...
                    <?php endif; ?>
                    <?php if( Auth::check() && settings('payment_btcpayserver') &&
        ...
        <div class="modal__content">
            <div class="modal__invite">
                ...
                <p class="modal__text">
                    ...
                    <br>
                    <br>
                    Join the <?php echo e(config('app.name')); ?> community of over 10.000 players who share a passion for fun
                    games,
                    spectacular HD graphics and promotional offers!
                    <br>
                    <br>
                    It’s easy: Invite your Friends and earn UNLIMITED Bonus Play! The <?php echo e(config('app.name')); ?> Referral
                    Rewards
                    program wars designed with YOU in mind. Earn as much as you can for free by welcoming new players to
                    the <?php echo e(config('app.name')); ?> community. Every referral earns you $<?php echo e($invite ?
                    number_format($invite->sum, 2,".","") : 0); ?> in Bonus Rewards!
                    Plus, every person you invite gets a free $<?php echo e($invite ? number_format($invite->sum_ref, 2,".","") :
                    0); ?> Bonus when they use purchase code for first-time deposit of $<?php echo e($invite ?
                ...
                <div class="modal__table-wrap avoid-scroll custom-scroll" data-simplebar>
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <?php if( Auth::check() && auth()->user()->shop && auth()->user()->shop->progress_active ): ?>
                            <?php $progress = \VanguardLTE\Progress::where(['shop_id' =>
                            auth()->user()->shop_id])->orderBy('rating')->get() ?>
                            <?php if($progress): ?>
                            ...
                            <tr <?php if($item->rating == auth()->user()->rating): ?> class="selected" <?php endif; ?>>
                                <td class="big-td">
                                    <img src="/frontend/Default/img/badges64x64/badge-<?php echo e($item->badge()); ?>.png" alt="">Range #<?php echo e($item->rating); ?>
        ...
        <div class="modal__content">
            ...
            <div class="modal__invite-block">
                <div class="modal__invite-item">
                    ...
                    <?php if( Auth::check() && count(auth()->user()->rewards())): ?>
                    ...
                    <div class="modal__invite-phones">
                        ...
                        <div class="modal__invite-row" id="reward<?php echo e($reward->id); ?>">
                            <div class="modal__invite-info">
                                <div class="modal__invite-date"><?php echo e(\Carbon\Carbon::parse($reward->created_at)->format(config('app.date_format'))); ?>
                                ...
                                <div class="modal__invite-phones-value">
                                    ...
                                    +<?php echo e($reward->referral->phone); ?>
                            ...
                            <div class="modal__invite-phones-btn">
                                <a href="javascript:;" class="btn take_reward" data-id="<?php echo e($reward->id); ?>">Take
                                    bonus</a>
                            </div>
                            <?php endif; ?>
                        </div>
    ...
    <div class="modal__body">
        <div class="modal__content">
            ...
            <div class="modal__invite-block">
                ...
                <div class="modal__invite-item">
                    <div id="show_phone" <?php if( Auth::check() && (auth()->user()->sms_token &&
                        !auth()->user()->phone_verified)): ?> style="display: none; " <?php endif; ?>>
                        <div class="modal__invite-label">Enter phone number</div>
                        <div class="modal__invite-input">
                            <input type="text" class="loginInput " autocomplete='off' id="myPhone" value="+<?php echo e(Auth::check() ? auth()->user()->formatted_phone() : '--'); ?>">
                        </div>
                    </div>

                    <?php if(Auth::check() ): ?>
                    <div id="show_sms_timer" <?php if( !(auth()->user()->sms_token && !auth()->user()->phone_verified)): ?>
                        ...
                        <div class="modal__invite-input">
                            ...
                            <span id="show_sms_timer_item" <?php if( !(auth()->user()->sms_token &&
                                !auth()->user()->phone_verified)): ?> style="display: none" <?php endif; ?>>
                                <?php
                                ...
                                $timer_text = ($minutes < 10 ? "0" . $minutes : $minutes) . ':' . ($seconds < 10 ? "0" . $seconds : $seconds); } ?> <span id="sms_timer" class="sms-code accent" data-seconds="<?php echo e($times); ?>">
                                    <?php echo e($timer_text); ?>
            ...
            <div class="modal__invite-btn">
                <?php if( Auth::check() ): ?>
                <a href="javascript:;" class="btn verifyMyPhone" id="verifyMyPhone" <?php if( auth()->user()->sms_token &&
                    !auth()->user()->phone_verified): ?> style="display: none" <?php endif; ?>>Send code</a>

                <a href="javascript:;" class="btn" id="ckeckCode" <?php if( !(auth()->user()->sms_token &&
                    !auth()->user()->phone_verified)): ?>style="display: none" <?php endif; ?>>Check code</a>
                <?php endif; ?>
            </div>
            <span class="close-btn">
                <img src="/frontend/Default/img/_src/close.svg" alt="">
...
<?php if( Auth::check() && auth()->user()->shop): ?>
<?php $__currentLoopData = ['privacy_policy', 'general_bonus_policy', 'why_bitcoin', 'responsible_gaming', 'terms_and_conditions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php if(auth()->user()->shop->{'rules_' . $modal}): ?>
<?php $rule = \VanguardLTE\Rule::where('href', $modal)->first(); ?>
<?php if($rule): ?>
<div class="modal modal-<?php echo e($modal); ?>">
    <div class="modal__body">
        <div class="modal__content">
            <h3 class="modal__title"><?php echo e($rule->title); ?></h3>
            <div class="modal__<?php echo e($modal); ?> modal__custom_scroll custom-scroll" data-simplebar><?php echo $rule->text; ?></div>
            <span class="close-btn">
...
<?php if(Auth::check() && auth()->user()->shop && auth()->user()->shop->rules_terms_and_conditions &&
!auth()->user()->agreed): ?>
<?php $rule = \VanguardLTE\Rule::where('href', 'terms_and_conditions')->first(); ?>
<?php if($rule): ?>
<div class="modal modal-terms_and_conditions2">
    <div class="modal__body">
        <div class="modal__content">
            ...
            <a href="<?php echo e(route('frontend.profile.agree')); ?>" class="btn">Agree</a>
        </div>
    </div>
</div>
<?php endif; ?>
            ...
            <div class="login-content">
                ...
                <div class="login-body">
                    <form action="<?= route('frontend.auth.login.post') ?>" class="" method="POST">
                        <?php echo csrf_field(); ?>
                        <input type="text" placeholder="<?php echo app('translator')->get('app.email_or_username'); ?>" class="login-input" name="username">
                        <input type="password" placeholder="<?php echo app('translator')->get('app.password'); ?>" class="login-input" name="password">
                        <a href="<?php echo e(url('password/remind')); ?>" class="forgot-pass-login">Forgot password ?</a>
                        <button type="submit" class="login-blue-btn"><?php echo app('translator')->get('app.log_in'); ?></button>
...
<div class="modal modal-register">
    <div class="modal__body">
        <div class="modal__content">
            <div class="login-content">
                <div class="login-header">
                    <div class="modal-content__header__row big"><?php echo app('translator')->get('app.register'); ?></div>
                    <!-- <div class="modal-content__header__row small">Welcome to Seibet</div> -->
                    <span class="login-close-modal close-btn">
                        <img src="/frontend/Default/img/_src/close.svg" alt="">
                    </span>
                ...
                <div class="login-body">
                    <form action="<?= route('frontend.auth.login.post') ?>" class="" method="POST">
                        <?php echo csrf_field(); ?>
                        <input type="text" placeholder="<?php echo app('translator')->get('app.username'); ?>" class="login-input" name="username">
                        <input type="email" placeholder="<?php echo app('translator')->get('app.email'); ?>" class="login-input" name="email">
                        <input type="password" placeholder="<?php echo app('translator')->get('app.password'); ?>" class="login-input" name="password">
                        <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Confirm Password" class="login-input">
                        <button type="submit" class="login-blue-btn"><?php echo app('translator')->get('app.register'); ?></button>
                    </form>    
                    <?php if(isset ($errors) && count($errors) > 0): ?>
                    <div class="notification">
                        <div class="notification__message notification__message_failed _active">
    ...
    <div class="profile-modal" id="my-account">
        <header class="modal__header">
            <p style="text-align:left; margin-left:15px; font-size:20px; padding-top:20px;">
                ...
                <?php echo e(settings('app_name')); ?>.....Your Casino Profile
            </p>
        ...
        <div class="popup">
            <div class="popup__body">
                ...
                <div class="popup__cont " id="div_profile">
                    <span class="a" style="font-family:roboto; color:#000; font-size:22px;">Welcome to your profile page! </span><span class="a" style="font-family:Montserrat Alternates; color:#3992c7;font-size: 26px;"> <?php echo e(auth()->user()->username); ?></span>
                    <br><br>
                    <form class="popup__form">
                        <div class="profile">
                            ...
                            <ul class="col-6 footer__item-acc-info" style="padding: 5px 0px;">
                                Current Balances!
                                <br>
                                <li class="font-black" style="display: inline-block; padding:10px 0;"><span class="info-name">You Balance!: </span> <span class="info-value balanceValue"><?php echo e(number_format(auth()->user()->balance, 2, '.', '')); ?>

                                        <?php echo e(isset($currency) ? $currency : 'USD'); ?></span></li>
                                <li class="font-black" style="display: inline-block; padding:10px 0;"><span class="info-name">Your Bonus!: </span> <span class="info-value bonusValue"><?php echo e(number_format(auth()->user()->bonus, 2, '.', '')); ?>

                                        <?php echo e(isset($currency) ? $currency : 'USD'); ?></span></li>
                                <li class="font-black" style="display: inline-block; padding:10px 0;"><span class="info-name">Your Wager!: </span> <span class="info-value wager"><?php echo e(number_format(auth()->user()->wager, 2, '.', '')); ?>
                            ...
                            <div class="history__cont">
                                <table class="table table--history">
                                    ...
                                    <tbody id='sports-bet-history'>
                                        ...
                                        <?php else: ?>
                                        <tr>
                                            <td colspan="8"><?php echo app('translator')->get('app.no_data'); ?></td>
                                        </tr>
                                        <?php endif; ?> -->
                                    </tbody>
                                </table>
                ...
                <div class="popup__cont" id="div_withdraw">
                    ...
                    <div class="info-value"><span>You Balance!:</span> <span><?php echo e(number_format(auth()->user()->balance, 2, '.', '')); ?>
...
<script>
    ...
    $('.sport-history').click(function() {
        $.ajax({
            ...
            type: 'get',
            data: {
                user_id: "<?php echo e(Auth::check() ? Auth::user()->id :  ''); ?>"
            }
...
<script>
    console.log("<?php echo $messages[array_rand($messages)];; ?>");
</script>
<?php endif; ?>
<?php if(isset ($errors) && count($errors) > 0): ?>
<?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<script>
    console.log("<?php echo e($error); ?>");
</script>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<script>
...
<!-- /.MAIN --><?php /**PATH /var/www/casino/resources/views/frontend/Default/partials/footer.blade.php ENDPATH**/ ?>