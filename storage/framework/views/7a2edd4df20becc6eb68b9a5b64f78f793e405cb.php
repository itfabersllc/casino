    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-footer">
                ...
                <?php if (\Auth::user()->hasPermission('shops.hard_delete')) : ?>
                ...
                <?php if (\Auth::user()->hasPermission('shops.delete')) : ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/itfabers/casino.dev.itfabers.com/resources/views/backend/shops/edit.blade.php ENDPATH**/ ?>