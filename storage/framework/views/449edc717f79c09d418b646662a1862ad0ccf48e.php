...
<body class="hold-transition skin-black sidebar-mini <?php if(isset($_COOKIE['sidebar-collapse']) && $_COOKIE['sidebar-collapse'] == 'true'): ?> sidebar-collapse <?php endif; ?>">
<div class="wrapper">
    ...
    <footer class="main-footer">
        <div class="pull-right hidden-xs">
              Unlimited Edition <strong>8.5</strong> Build <strong>2290</strong>
        </div>
          
			<strong><a href="http://localhost/"><?php echo e(settings('app_name')); ?></a></strong> - Game Management System
    </footer>
...
<script>
    var timezon = '<?php echo e(date_default_timezone_get()); ?>';
...
</html><?php /**PATH /home/itfabers/casino.dev.itfabers.com/resources/views/backend/layouts/app.blade.php ENDPATH**/ ?>