...
<script>
    ...
    var hostname = window.location.hostname;
        ...
        SELSVRURL='https://'+hostname+"/game/<?php echo e($game->name); ?>/server?sessionId="+sessionStorage.getItem('sessionId')+"&command=init";

    } else {

        WEBSOCKETURL= 'ws://' + hostname;

        SELSVRURL='http://'+hostname+"/game/<?php echo e($game->name); ?>/server?sessionId="+sessionStorage.getItem('sessionId')+"&command=init";
...
console.error(list);
    ...
    xhr.open('GET', 'manifest/1005.json?v=' + Math.random(), true);
...
</html><?php /**PATH C:\OSPanel\domains\cas.loc\resources\views/frontend/games/list/YaoQianShu10000VP.blade.php ENDPATH**/ ?>