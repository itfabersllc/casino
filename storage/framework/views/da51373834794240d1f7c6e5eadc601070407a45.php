...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input type="number" step="0.0000001" class="form-control" name="position" placeholder="<?php echo app('translator')->get('app.position'); ?>" required value="<?php echo e($edit ? $category->position : ''); ?>">
    </div>
</div>
<div class="col-md-6">
    <div class="form-group">
...
<?php /**PATH /var/www/casino/resources/views/backend/categories/partials/base.blade.php ENDPATH**/ ?>