...
<head>
	...
	<base href="/games/MoonFestivalAT/" target="_blank" >
...
$(document).ready(function(){
	...
	loader.init({
		server:location.hostname+'/game/MoonFestivalAT/server?sessionId='+sessionStorage.getItem('sessionId'),
		gameDiv:'gameDiv',
...
</html><?php /**PATH C:\OSPanel\domains\cas.loc\resources\views/frontend/games/list/MoonFestivalAT.blade.php ENDPATH**/ ?>