...
<div data-v-988aaf82="" class="casino-game-item">
    <div data-v-12e05bc3="" data-v-988aaf82=""
        ...
        <div data-v-2574a256="" data-v-12e05bc3=""
            ...
            <img data-v-2574a256="" class="lazy image" src="/frontend/Default/img/_src/game_loader.png" data-src="<?php echo e($game->name ? '/frontend/Default/ico/' . $game->name . '.jpg' : ''); ?>" alt="<?php echo e($game->title); ?>">
            <!---->
        ...
        <?php if(Auth::check()): ?>
            <a href="<?php echo e(route('frontend.game.go', $game->name)); ?>?api_exit=/" class="checkAgreed btn" style="padding: 3px 6px;margin: 2px 0px;">Play</a>
        <?php else: ?>
        ...
        <div data-v-12e05bc3="" class="info">
            <div data-v-12e05bc3="" class="name"><?php echo e($game->title); ?></div>
            <!---->
        </div>
    </div>
</div>
<?php /**PATH /var/www/casino/resources/views/frontend/Default/partials/game.blade.php ENDPATH**/ ?>