<tr>
    <td>
		<?php if(auth()->user()->hasRole('admin') || auth()->user()->hasRole('agent') || auth()->user()->hasRole('distributor')): ?>
...
</tr><?php /**PATH /home/itfabers/casino.dev.itfabers.com/resources/views/backend/games/partials/row.blade.php ENDPATH**/ ?>