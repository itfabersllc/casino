...
<body class="<?php echo $__env->yieldContent('add-body-class'); ?>">
	<script type="text/javascript">
		var is_games_page = <?php if(isset($is_game_page)): ?> true <?php else: ?> false <?php endif; ?>;
		var terms_and_conditions = <?php if(Auth::check() && auth()->user()->shop && auth()->user()->shop->rules_terms_and_conditions && !auth()->user()->agreed): ?> true <?php else: ?> false <?php endif; ?>;
	</script>

	<!-- MAIN -->
	<main class="main <?php echo $__env->yieldContent('add-main-class'); ?>" style="z-index: 50; padding-bottom: 0px;">
...
</html><?php /**PATH /var/www/casino/resources/views/frontend/Default/layouts/app.blade.php ENDPATH**/ ?>